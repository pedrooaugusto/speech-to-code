...
const i18n_ = {
    'en-US': {
        ...
        'source': <>
            Check out the <a rel='noreferrer' href='/en/webapp'>demo</a> to see it working or read more about it at&nbsp;
    ...
    'pt-BR': {
        ...
        'source': <>
            Confira a <a rel='noreferrer' href='/pt/webapp'>demonstração</a> ou leia mais no&nbsp;
